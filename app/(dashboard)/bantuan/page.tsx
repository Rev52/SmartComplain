  ...
  return (
    <div className="max-w-6xl relative z-10 -mt-2 pb-10">
      ...
      <div className="mt-4 mb-6">
        <h1 className="text-[32px] font-bold text-[#0A2647] mb-2">{t.bantuan.title}</h1>
      ...
      <div className="bg-[#F8FAFC]/95 backdrop-blur-sm rounded-[20px] p-8 md:p-10 shadow-sm border border-slate-200 flex flex-col md:flex-row items-center justify-between mb-8 overflow-hidden relative">
        <div className="w-full md:w-3/5 relative z-10">
          <h2 className="text-2xl font-bold text-[#0A2647] mb-2">{t.bantuan.bannerTitle}</h2>
        ...
        <div className="hidden md:flex relative w-64 h-32 items-center justify-center">
          <img src="/QnA.png" alt="QnA" className="w-full h-full object-contain drop-shadow-md" />
        </div>
      </div>
        ...
        <div className="bg-[#F8FAFC]/95 backdrop-blur-sm rounded-[20px] p-6 sm:p-8 shadow-sm border border-slate-200">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-8 gap-x-6">
            ...
            <div className="flex flex-col gap-3">
              <p className="text-sm font-semibold text-slate-600">{t.bantuan.step1}</p>
              <div className="bg-[#0A2647] rounded-xl p-3 h-28 border shadow-sm flex flex-col gap-1.5 overflow-hidden">
                 ...
                 <div className="w-full h-8 bg-[#1C4E8A] rounded border border-blue-400/30 flex items-center px-2 shadow-inner">
                    <span className="text-[10px] text-white font-medium">{t.bantuan.step1Label}</span>
                 </div>
                 <div className="w-full h-4 bg-white/10 rounded"></div>
              </div>
            </div>
            ...
            {/* Step 2 */}
            <div className="flex flex-col gap-3">
              <p className="text-sm font-semibold text-slate-600">{t.bantuan.step2}</p>
              <div className="bg-white rounded-xl p-3 h-28 border shadow-sm flex flex-col justify-center">
                 <p className="text-[10px] font-bold text-[#0A2647] mb-1">{t.bantuan.step2Label1}</p>
                 <div className="w-full h-8 border border-slate-200 rounded flex items-center px-2 gap-2 bg-slate-50">
                    <Lock className="w-3 h-3 text-slate-400" />
                    <span className="text-[9px] text-slate-400">{t.bantuan.step2Label2}</span>
                 </div>
              </div>
            </div>
            ...
            {/* Step 3 */}
            <div className="flex flex-col gap-3">
              <p className="text-sm font-semibold text-slate-600">{t.bantuan.step3}</p>
              <div className="bg-white rounded-xl p-3 h-28 border shadow-sm flex flex-col justify-center">
                 <p className="text-[10px] font-bold text-[#0A2647] mb-1">{t.bantuan.step3Label1}</p>
                 <div className="w-full h-8 border border-slate-200 rounded flex items-center px-2 gap-2 bg-slate-50">
                    <MapPin className="w-3 h-3 text-slate-400" />
                    <span className="text-[9px] text-slate-400">{t.bantuan.step3Label2}</span>
                 </div>
              </div>
            </div>
            ...
            {/* Step 4 */}
            <div className="flex flex-col gap-3">
              <p className="text-sm font-semibold text-slate-600">{t.bantuan.step4}</p>
              <div className="bg-white rounded-xl p-3 h-28 border shadow-sm flex items-center justify-center">
                 <div className="border border-blue-200 bg-blue-50 px-3 py-1.5 rounded-full flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] font-semibold text-blue-600">{t.bantuan.step4Label}</span>
                 </div>
              </div>
            </div>
            ...
            {/* Step 5 */}
            <div className="flex flex-col gap-3">
              <p className="text-sm font-semibold text-slate-600">{t.bantuan.step5}</p>
              <div className="bg-white rounded-xl p-3 h-28 border shadow-sm flex flex-col">
                 <p className="text-[10px] font-bold text-[#0A2647] mb-1">{t.bantuan.step5Label1}</p>
                 <div className="w-full flex-1 border border-slate-200 rounded p-2 bg-slate-50">
                    <span className="text-[8px] text-slate-400">{t.bantuan.step5Label2}</span>
                 </div>
              </div>
            </div>
            ...
            {/* Step 6 */}
            <div className="flex flex-col gap-3">
              <p className="text-sm font-semibold text-slate-600">{t.bantuan.step6}</p>
              <div className="bg-white rounded-xl p-3 h-28 border shadow-sm flex flex-col">
                 <p className="text-[10px] font-bold text-[#0A2647] mb-1">{t.bantuan.step6Label1} <span className="text-[8px] text-slate-400 font-normal">{t.bantuan.step6Label2}</span></p>
            ...
            {/* Step 7 */}
            <div className="flex flex-col gap-3">
              <p className="text-sm font-semibold text-slate-600">{t.bantuan.step7}</p>
              <div className="bg-white rounded-xl p-3 h-28 border shadow-sm flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[#F8FAFC]/95 backdrop-blur-sm rounded-[20px] p-8 shadow-sm border border-slate-200 h-fit">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/faq" className="text-xs font-semibold text-blue-600 hover:underline">{t.bantuan.faqLink}</Link>
          </div>
        ...
        <div className="bg-[#F8FAFC]/95 backdrop-blur-sm rounded-[20px] p-8 shadow-sm border border-slate-200 h-fit">
          <h3 className="font-bold text-slate-700 mb-6">{t.bantuan.hubungiTitle}</h3>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 flex items-center gap-5 shadow-sm hover:border-blue-300 transition-colors cursor-pointer">
              ...
              <div>
                <h4 className="font-bold text-[#0A2647] text-[15px] mb-0.5">Call Center</h4>
                <p className="text-xs text-slate-500 font-medium">031-2874-6525</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 flex items-center gap-5 shadow-sm hover:border-purple-300 transition-colors cursor-pointer">
              ...
              <div>
                <h4 className="font-bold text-[#0A2647] text-[15px] mb-0.5">Email</h4>
                <p className="text-xs text-slate-500 font-medium">support.smartcomplain@gmail.com</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 flex items-center gap-5 shadow-sm hover:border-orange-300 transition-colors cursor-pointer">
              ...
              <div>
                <h4 className="font-bold text-[#0A2647] text-[15px] mb-0.5">{t.bantuan.alamat}</h4>
                <p className="text-xs text-slate-500 font-medium">{t.bantuan.alamatDesc}</p>
              </div>
            </div>
          </div>
        </div>
