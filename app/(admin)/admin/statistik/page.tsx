...
export default function StatistikPage() {
  ...
  const kategoriData: ChartItem[] = Object.entries(kategoriCount).map(
      ...
      <div className="admin-page">
        ...
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Ringkasan data laporan berdasarkan kategori dan kecamatan.
          </p>
        </div>
              ...
              <BarChart data={kategoriData}>
                ...
                <Bar dataKey="value" radius={[8, 8, 0, 0]}>
                  {kategoriData.map((_, i) => (
                    <Cell
                      key={i}
                      fill={KATEGORI_COLORS[i % KATEGORI_COLORS.length]}
                    />
                  ))}
                </Bar>
              </BarChart>
