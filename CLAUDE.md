...
2. **Server vs Client Components:** - Gunakan Server Components secara default untuk performa maksimal.
   - Tambahkan direktif `"use client"` di bagian atas file _hanya_ jika komponen membutuhkan interaktivitas (seperti `onClick`, form state, hooks, atau rendering chart).
...
- Jika membuat _mock data_ untuk laporan, gunakan konteks kota Surabaya (contoh jalan: Jl. Darmo, Jl. Jagir Wonokromo, dll).
- Prioritaskan _accessibility_ (aria-labels) pada elemen form dan tombol.
