  ...
  return (
    <nav className="bg-[#0A2647] text-white py-4 px-8 flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="hidden md:flex items-center gap-8 text-sm font-medium">
        <Link href="#tentang" className="hover:text-blue-300 transition-colors">Tentang</Link>
        <Link href="#fitur" className="hover:text-blue-300 transition-colors">Fitur</Link>
        <Link href="#cara-kerja" className="hover:text-blue-300 transition-colors">Cara Kerja</Link>
      </div>
